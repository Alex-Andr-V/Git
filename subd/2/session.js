...
exports.login = function(req, login, pass) {
var cookies = req.cookies
var secret = cookies['app_user']
var user = await req.db.one('SELECT * FROM users WHERE login
= $1', login)
if (user && (user.pass_hash == md5(pass))) {
var secret = 'secret';
...
if (!session.active || ((current_timestamp -
session.timestamp) > 43200*1000)) {
return 0;
}
return session;
}
